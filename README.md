...
2). โปรแกรมสำหรับรับตัวอักษรจากคีย์บอร์ด 
 ...
 ![](https://github.com/Desktop-Programming-Lab-2559/LAB-06/blob/master/imgs/pic1.png)
  ...
  ![](https://github.com/Tooktasupaporn/LAB-06/blob/master/pj6%201.PNG?raw=true)
<hr>
<hr>
<hr>
<hr>
...
-จะแสดงเฉพาะตัวแรกเท่านั้นเพราเราประกาศ char ไว้แค่ตัวเดียว
<hr>
<hr>
<hr>
<hr>
...
จะทำให้ผลการรัน error เพราะว่ามันไม่รู้ว่า ch คืออะไร แล้วจะเอาผลจากไหนมาแสดง
<hr>
<hr>
<hr>
<hr>
...
3).	โปรแกรมสำหรับรับ string จากคีย์บอร์ด
 ...
 ![](https://github.com/Tooktasupaporn/LAB-06/blob/master/pj6%202.PNG?raw=true)
<hr>
<hr>
<hr>
<hr>
...
![](https://github.com/Tooktasupaporn/LAB-06/blob/master/pj6%203.PNG?raw=true)
<hr>
<hr>
<hr>
<hr>
...
-จะทำให้ผลการรัน error การป้องกันโดยใช้ try{..} catch{...}
<hr>
<hr>
<hr>
<hr>
...
5).	โปรแกรมสำหรับรับค่าตัวเลข แต่ในบางกรณีที่ผู้ใช้ป้อนตัวอักษร จะทำให้เกิด error และทำให้โปรแกรม hang ได้ จึงต้องมีการป้องกันโดยใช้ประโยค ```try{…} catch{…}```  (ประโยค ```try{…} catch{…}``` นี้จะศึกษารายละเอียดภายหลัง)
  ...
  ![](https://github.com/Tooktasupaporn/LAB-06/blob/master/pj6%204.PNG?raw=true)
<hr>
<hr>
<hr>
<hr>
...
-หากป้อนตัวอักษรลงไปแทนตัวเลขจะทำให้ผลการรัน error เพราะเราประการให้เป็นประเภท int
<hr>
<hr>
<hr>
<hr>
...
![](
https://github.com/Tooktasupaporn/LAB-06/blob/master/pj%20name.PNG?raw=true
)
